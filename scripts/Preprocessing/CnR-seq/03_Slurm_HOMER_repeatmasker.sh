...
#   ~/macs3_test/ZNF90_shared_peaks_bedtools_intersect.narrowPeak \
#   /scratch/users/u15756/homer_data/genomes/rheMac10 \
#   ~/macs3_test/homer_motif_output \
#   -size 200
...
##this one works but can't see known TFs
# apptainer exec \
#   --bind $HOME:$HOME \
#   --bind /scratch/users/u15756/homer_data:/opt/conda/share/homer/data \
#   /sw/container/bioinformatics/homer-latest.sif \
#   /opt/conda/share/homer/bin/findMotifsGenome.pl \
#   ~/macs3_test/ZNF90_shared_peaks_bedtools_intersect.narrowPeak \
# /opt/conda/share/homer/data/genomes/hg38/genome.fa \
#   ~/macs3_test/homer_motif_output \
#   -size 200  
#   
#   
